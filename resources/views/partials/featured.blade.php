            ...
            <div class="bg-white py-4 mb-4">
                <div class="row mx-4 my-4 product-item-2 align-items-start">
                    ...
                    <div class="col-md-4 ml-auto product-title-wrap">
                        ...
                        <p>
                            <form action="{{route('shop.additem')}}" method="POST" class="col-md-4">
                                @csrf
                            ...
                            {{-- <a href="{{route('shop.additem',[$producto->id])}}" class="btn btn-black rounded-1 d-block d-lg-inline-block">Add Item</a> --}}
